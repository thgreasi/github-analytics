...
describe('Subject', function () {
    ...
    it('should have the rxSubscriber Symbol', function () {
        var subject = new Subject();
        chai_1.expect(subject[Rx.Symbol.rxSubscriber]).to.be.a('function');
    });
    ...
    it('should allow ad-hoc subscription to be added to itself', function () {
        ...
        auxSubject.next('c');
        auxSubject.next('d');
        chai_1.expect(results1).to.deep.equal([1, 2, 3]);
        chai_1.expect(subscription2.isUnsubscribed).to.be.true;
        chai_1.expect(results2).to.deep.equal(['a', 'b']);
    });
    it('should allow ad-hoc subscription to be removed from itself', function () {
        ...
        auxSubject.next('d');
        chai_1.expect(results1).to.deep.equal([1, 2, 3]);
        chai_1.expect(subscription2.isUnsubscribed).to.be.false;
        chai_1.expect(results2).to.deep.equal(['a', 'b', 'c', 'd']);
    });
    ...
    describe('asObservable', function () {
        ...
        it('should work with inherited subject', function (done) {
            ...
            observable.materialize().subscribe(function (x) {
                ...
                chai_1.expect(expected).to.deep.equal([]);
                done();
            });
        });
